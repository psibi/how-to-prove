...
\section{Solution 15}
Suppose $F$ is a partition of $A$ and $G$ is a partition of $B$ and $A$
and $B$ are disjoint.
...
Anti-symmetric \\
Let $F,G$ be an arbitrary element on $P$. Suppose $X \in F$. From
$FRG$, it follows that $Y \subseteq X'$ for some $X' \in F$. From $X
\subseteq Y$ and $Y \subseteq X'$, it follows that $X \subseteq X'$.
Since both $X$ and $X'$ are members of the partition $F$ and $X
\subseteq X'$, it follows that $X = X'$. From $X \subseteq Y$ and $Y
\subseteq X'$, it follows that $X = Y$. We know from $FRG$ that $X \in
F$ and $Y \in G$, it follows that $F \subseteq G$. Similarly from
$GRF$, we know that $Y \in G$ and $X' \in F$. It follows that $G
\subseteq F$. So, $G = F$. Hence proved.
...
Let $L$ be the set of lower bound of $\{F,G\} \in R$. Let$A$ be an
arbitrary element in $L$. To prove that $F.G$ is the greatest lower
bound we have to prove that $A R F.G$. Simplifying this, we need to
prove that $X \subseteq F_1 \cap G_1$ for an arbitrary $X \in A$ and
some $F_1 \in F$ and $G_1 \in G$. Since $A \in L$, it follows that
$ARF$ and $ARG$.Let $X$ be an arbitrary element in $A$. From $ARF$, it
follows that $X \subseteq F_1$. Similarly, we get $X \subseteq G_1$.
So, $X \subseteq F_1 \cap G_1$. Hence proved.
